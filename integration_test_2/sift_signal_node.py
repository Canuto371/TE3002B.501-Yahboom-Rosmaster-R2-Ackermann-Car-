...
class SIFTSignalNode(Node):
    ...
    def process_frame(self):
        ...
        # Temporal filtering
        # Requerimos 3 detecciones consecutivas del mismo label.
        # Además, NO publicamos unknown para no saturar /detected_signal.
        ...
        if len(self.last_roi_boxes) > 0:
            x1, y1, x2, y2 = self.last_roi_boxes[0]
        ...
        msg = String()
        msg.data = f"{label},{score},{area_ratio:.4f}"
